...
ddistool: $(OBJECTS) src/tool_plot_ddis.o 
	g++ $(OBJECTS) src/tool_plot_ddis.o $(AMPLITUDEPATH)/libamplitude.a ${MINUITLIBDIR}/libMinuit2.a -o ddistool $(CXXFLAGS) $(PROFFLAGS) $(LDFLAGS)
...
clean:
	rm -f $(OBJECTS) $(AMPLITUDELIBO) src/main.o src/toolF2.o src/main_switches.o src/tool_plot.o src/tool_plot_ddis.o src/tool_fl.o src/swarmscan.o src/massive_swarmscan.o src/lightq_scan.o src/lightq-fit.o src/sub_unsub_test.o src/lo-fit-plot.o
	rm -f fit fitex tool plottool ddistool fltool swarmscan massivescan lightqscan subunsub lightqfitex lofit
