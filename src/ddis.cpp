...
double I_ddis_lo_qqbar_L(double Q, double beta, double z, double x01sq, double conj_x01sq) {
    double res;

}

double I_ddis_lo_qqbar_T(double Q, double beta, double z, double x01sq, double conj_x01sq) {
    double res;
